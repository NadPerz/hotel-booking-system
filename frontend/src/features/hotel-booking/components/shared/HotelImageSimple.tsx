...
// import mediaWrapperApi from '@frontend/features/hotel-booking/lib/media-wrapper.api';
...
//       try {
//         const signedUrl = await mediaWrapperApi.getSignedUrl(imagePath, imagePath);
